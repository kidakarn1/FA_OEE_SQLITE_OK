...
Public Class Confrime_work_production
    ...
    Public Shared Function next_pae()
        ' No Detail/NEXT reload may abandon a durable ACTIVE transfer by assigning
        ' a different Current PWI or sequence.
        If Working_Pro.HasIncompleteTransferOwnershipPendingConfirmation() Then
            MessageBox.Show("A Continue Existing Box reservation must be confirmed, completed, or recovered before changing production sequence.",
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Console.WriteLine("Over Plan Or  ===> " & ex.Message)
    ...
    Public Shared Sub loadData_Working_OEE()
        Working_Pro.Show()
        Working_Pro.ShowPendingProductionActionWhenReady()
