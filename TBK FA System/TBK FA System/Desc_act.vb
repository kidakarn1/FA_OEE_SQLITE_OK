        ...
        Else
            If CDbl(Val(Working_Pro.LB_COUNTER_SHIP.Text)) > 0 Then
                ...
                If CDbl(Val(TextBox1.Text)) <= CDbl(Val(Label1.Text)) Then
                    ...
                    Dim beforeDecQty As Integer = CInt(Val(Working_Pro.lb_qty_for_box.Text))
                    ...
                    End If
                    Dim afterDecQty As Integer = CInt(Val(Working_Pro.lb_qty_for_box.Text))
#If DEBUG Then
                    System.Diagnostics.Debug.WriteLine("[BOX-QTY] EVENT | Type=ManualDecrease | Delta=" & inp_qty.ToString() &
                                                       " | Before=" & beforeDecQty.ToString() & " | After=" & afterDecQty.ToString())
#End If
                    Console.WriteLine("[BOX-QTY] EVENT | Type=ManualDecrease | Delta=" & inp_qty.ToString() &
                                      " | Before=" & beforeDecQty.ToString() & " | After=" & afterDecQty.ToString())
