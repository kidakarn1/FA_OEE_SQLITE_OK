...
Public Class Line_conf
    ...
    Public Function SyncControlMaster(cavityValue As Integer, Optional useFormValues As Boolean = False) As String
        ...
        Else
            'When opened from Detail, preserve the existing master settings and
            'change only the cavity quantity.
            Try
                ...
                End If
            Catch
                'Fallback to the already loaded MainFrm values below.
            End Try
            Try
    ...
    Private Sub combo_cavity_SelectedIndexChanged(sender As Object, e As EventArgs) Handles combo_cavity.SelectedIndexChanged
