...
Public Class Prd_detail
    ...
    Public Sub check_lot()
        Try
            ...
            If i > 0 Then
                ...
                End If
            Else
                ''msgBox("เธเธฃเธธเธ“เธฒเธฅเธเธเนเธญเธกเธนเธฅเธเธเธฑเธเธเธฒเธเน€เธเธทเนเธญเน€เธฃเธดเนเธกเธเธฒเธฃเธเธฅเธดเธ•")
            End If
            '    Else
            '      load_show.Show()
            '   End If
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            If shift = "A" Then 'เธเธฐเน€เธเนเธฒ'
                If TimeOfDay.ToString("HH:mm:ss") <= "07:40:00" And TimeOfDay.ToString("HH:mm:ss") <= "07:40:00" Then 'เธเธฐเน€เธเนเธฒ'
                    Confrime_work_production.Show()
                Else
                    Confrime_work_production.next_pae()
                End If
            ElseIf shift = "P" Then 'เธเธฐเน€เธเนเธฒ'
                If TimeOfDay.ToString("HH:mm:ss") >= "19:40:00" And TimeOfDay.ToString("HH:mm:ss") <= "20:00:00" Then 'เธเธฐเน€เธเนเธฒ'
                    Confrime_work_production.Show()
                Else
                    Confrime_work_production.next_pae()
                End If
            ElseIf shift = "B" Then 'เธเธฐเธ”เธถเธ'
                If TimeOfDay.ToString("HH:mm:ss") >= "19:40:00" And TimeOfDay.ToString("HH:mm:ss") <= "20:00:00" Then 'เธเธฐเน€เธเนเธฒ'
                    Confrime_work_production.Show()
                Else
                    Confrime_work_production.next_pae()
                End If
            ElseIf shift = "Q" Then 'เธเธฐเธ”เธถเธ'
