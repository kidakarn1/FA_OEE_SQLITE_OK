Public Class int_qty_rework
    ...
    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        ...
        If ins_qtyy > 0 And ins_qtyy <= max_val_int Then
            ...
            ' This is the accepted Rework quantity entry.  The legacy Actual
            ' flow remains unchanged; the Boolean only records physical-box
            ' contribution while a Continue Existing Box is active.
            Working_Pro.ins_qty_fn(True)
            Working_Pro.Enabled = True
            Me.Close()
        Else
            'msgBox("Insert mitaked! Please try it again.")
