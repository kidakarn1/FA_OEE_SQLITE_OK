...
Public Class printDefect
        ...
        Using aPen As New Pen(Color.Black)
            ...
            While i < defectDataList.Count
                ...
                If curY + lineHeight > bottomLimit Then
                    ...
                    ImageLifetime.ReplaceOwned(PictureBox1, QR_Generator.Encode(qrDefectinfo))
                    e.Graphics.DrawImage(PictureBox1.Image, 20, 10, 85, 85)
                    e.Graphics.DrawImage(PictureBox1.Image, 592, 195, 80, 80)

                    ImageLifetime.ReplaceOwned(PictureBox1, QR_Generator.Encode(qrDefectcodedetails))
            ...
            Try
                ...
                ImageLifetime.ReplaceOwned(PictureBox1, qrInfoImage)
                ...
                ImageLifetime.ReplaceOwned(PictureBox1, qrDetailImage)
    ...
    Private Function GenerateQrImageByQRCoder(qrText As String) As Image
        Using qrGenerator As New QRCoder.QRCodeGenerator()
            Using qrData As QRCoder.QRCodeData =
